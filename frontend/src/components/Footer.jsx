          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2 md:space-y-3">
                <Link href="#" className="text-xs md:text-sm xl:text-base hover:text-gray-600 transition-colors">Customer Support</Link>
                <Link href="#" className="text-xs md:text-sm xl:text-base hover:text-gray-600 transition-colors">Blogs</Link>
                <Link href="#" className="text-xs md:text-sm xl:text-base hover:text-gray-600 transition-colors">Terms & Conditions</Link>
                <Link href="#" className="text-xs md:text-sm xl:text-base hover:text-gray-600 transition-colors">Privacy Policy</Link>
              </div>
            </div>
