...
const Register = () => {
  ...
  return (
   <div>
    <Header/>
     <div className="flex md:min-h-screen md:items-center md:justify-center  py-12 px-4 sm:px-6 lg:px-8 ">
      <div className="w-full max-w-md space-y-8 border px-5 md:px-10 py-5 rounded-2xl">
        <div>
